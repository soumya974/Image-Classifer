...
# Train the model
model.fit(train_generator, validation_data=train_generator,epochs=num_epochs, class_weight=class_weight_dict, verbose=0)
...
print(f'The time of execute the code is {round((end - start) / 60) + 1} minutes')